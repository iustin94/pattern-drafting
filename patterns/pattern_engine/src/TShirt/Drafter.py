...
from patterns.pattern_engine.src.TShirt.Body import FrontTShirtBlock, BackTShirtBlock
from patterns.pattern_engine.src.TShirt.Sleeve import LongSleeveBlock, ShortSleeveBlock
